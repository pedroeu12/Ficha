...
object SpellData {
    ...
    val ALL: List<SpellDef> = listOf(
        ...
        SpellDef("poison_spray", "Poison Spray", 0, "Necromancy", "Action", "30 feet", "V, S", "Instantaneous",
            "You spray toxic mist at a creature within range. Make a ranged spell attack; on a hit the target takes 1d12 Poison damage. The damage increases by 1d12 at levels 5, 11, and 17.",
        ...
        SpellDef("shillelagh", "Shillelagh", 0, "Transmutation", "Bonus Action", "Self", "V, S, M", "1 minute",
            "A Club or Quarterstaff you hold is imbued with nature's power. You can use your spellcasting ability instead of Strength for its attack and damage rolls, and its damage die becomes a d8, changing to d10 at level 5, d12 at level 11, and 2d6 at level 17. The damage can be Force or the weapon's normal type.",
        ...
        SpellDef("inflict_wounds", "Inflict Wounds", 1, "Necromancy", "Action", "Touch", "V, S", "Instantaneous",
            "A creature you touch makes a Constitution saving throw, taking 2d10 Necrotic damage on a failed save or half as much on a success. The damage increases by 1d10 for each spell slot level above 1.",
        ...
        SpellDef("ice_storm", "Ice Storm", 4, "Evocation", "Action", "300 feet", "V, S, M", "Instantaneous",
            "Hail falls in a 20-foot-radius, 40-foot-high Cylinder. Each creature in it makes a Dexterity saving throw, taking 2d10 Bludgeoning damage and 4d6 Cold damage on a failure, or half as much on a success. The hailstones turn the ground there into Difficult Terrain until the end of your next turn.",
        ...
        SpellDef("phantasmal_force", "Phantasmal Force", 2, "Illusion", "Action", "60 feet", "V, S, M", "1 minute",
            "The target makes an Intelligence saving throw. On a failure you craft an illusion in its mind, no larger than a 10-foot Cube and perceivable only to it. On each of your turns the phantasm can deal 2d8 Psychic damage to the target if the target is in its area or within 5 feet of it.",
        ...
        SpellDef("wind_wall", "Wind Wall", 3, "Evocation", "Action", "120 feet", "V, S, M", "1 minute",
            "A wall of strong wind up to 50 feet long, 15 feet high, and 1 foot thick rises from the ground. When it appears, each creature in its area makes a Strength saving throw, taking 4d8 Bludgeoning damage on a failure or half as much on a success. It stops gases, and ordinary ranged weapons can't pass through it.",
        ...
        SpellDef("conjure_animals", "Conjure Animals", 3, "Conjuration", "Action", "60 feet", "V, S", "10 minutes",
            "You conjure nature spirits that flit around you in a 10-foot Emanation for the duration. Whenever the Emanation enters a creature's space, and whenever a creature enters it or ends its turn there, that creature makes a Dexterity saving throw, taking 3d10 Slashing damage on a failure. You have Advantage on Strength saving throws while within 5 feet of the pack.",
        ...
        SpellDef("grasping_vine", "Grasping Vine", 4, "Conjuration", "Bonus Action", "60 feet", "V, S", "1 minute",
            "You conjure a vine that sprouts from a surface in an unoccupied space you can see. Make a melee spell attack against a creature within 30 feet of the vine; on a hit the target takes 4d8 Bludgeoning damage and is pulled up to 30 feet toward the vine, and if it is Huge or smaller it has the Prone condition.",
